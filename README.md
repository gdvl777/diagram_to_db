...
**schema based on diagram** is a project to interpret a diagram, and implement the SQL needed to build that database.
...
```bash
  cd my-folder
  git clone git@github.com:gdvl777/diagram_to_db.git
```
...
Feel free to check the [issues page](https://github.com/gdvl777/diagram_to_db/issues).
...
If you like this project give it a star! :D
